...
namespace WindowsFormsApp1
{
    internal static class Program
    {
        ...
        static void Main()
        {
            NetworkTrainer w = new NetworkTrainer(2, 10, 32, 16, 100);
            NeuralNetwork final = w.Train();

            final.input = new double[2] { 1.0, 1.0 };
            final.Forward();
            ...
            final.input = new double[2] { 2.0, 3.0 };
            final.Forward();
            ...
            final.input = new double[2] { 0.0, 8.0 };
            final.Forward();
            // should return 0 and 1 or extremely close
            greatestIndex = 0;
            for (int i = 0; i < final.output.Length; i++)
            ...
            final.input = new double[2] { 1.0, 0.0 };
            final.Forward();
            // should return 1 and 0 or extremely close
            greatestIndex = 0;
            for (int i = 0; i < final.output.Length; i++)
            ...
            final.input = new double[2] { 4.0, 2.0 };
            final.Forward();
            // should return 1 and 0 or extremely close
            greatestIndex = 0;
            for (int i = 0; i < final.output.Length; i++)
